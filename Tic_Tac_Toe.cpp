...
std::string victor(){
     for(int i = 0; i < 3; i++){
        if((board[i][0] == board[i][1] and board[i][0] == board[i][2] and board[i][0] == 'X') or
           (board[0][i] == board[1][i] and board[0][i] == board[2][i] and board[i][0] == 'X')){
            return "X is victorius";
        } else if((board[i][0] == board[i][1] and board[i][0] == board[i][2] and board[i][0] == 'O') or
           (board[0][i] == board[1][i] and board[0][i] == board[2][i] and board[i][0] == 'O')){
